...
//
//
//@interface NewMaginzeBViewController ()
//{
//    
...
//@end
//
//@implementation NewMaginzeBViewController
//
//- (void)viewDidLoad {
//    [super viewDidLoad];
//    
...
//    //end
//
//    scrollView = [[JT3DScrollView alloc] init];
//    scrollView.effect = JT3DScrollViewEffectCards;
...
//        
//        UIAlertView* alert = [[UIAlertView alloc] initWithTitle:@"爱慕提示" message:@"请先登录" delegate:self cancelButtonTitle:@"登录" otherButtonTitles:@"取消",nil];
//        alert.tag = 10000000;
//        alert.delegate = self;
//        [alert show];
//        
...
//    
//    if (alertView.tag == 10000000 && buttonIndex == 0) {
...
//    
//    [ShareUnit ShareSDKwithTitle:[dataB.title description].length>0?[dataB.title description]:@"爱慕分享"
//                         content:[dataB.synopsis_text description].length>0?[dataB.synopsis_text description]:@"我在爱慕发现了一款好的产品，欢迎下载"
//                  defaultContent:dataB.synopsis_text
//                           img:bgimageV.image
//                           url:@"http://m.aimer.com.cn/method/xiazai"
//                   description:[dataB.synopsis_text description].length>0?[dataB.synopsis_text description]:@"我在爱慕发现了一款好的产品，欢迎下载"];
//}
//
//
...
//
//
//- (void)createCardWithobject:(NewMaginzeDetailInfo_dataB* )sender andIndex:(int)aindex
//{
...
//
//        
//        UILabel *threelab = [[UILabel alloc] initWithFrame:CGRectMake(10,secondlab.frame.origin.y + contentHight + 40, width - 20, 180)];
