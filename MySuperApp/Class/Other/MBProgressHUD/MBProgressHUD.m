...
#define TopMove 40    //视图离顶部的距离
#define BottomMove 0  //视图离底部的距离
...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
        ...
        rect.origin.y = TopMove;
        rect.size.height = self.frame.size.height - TopMove - BottomMove;
        self.frame = rect;
	}
	return self;
}
...
- (void)layoutSubviews {
    ...
    labelSize = [label.text sizeWithFont:label.font constrainedToSize:CGSizeMake(labelSize.width, MAXFLOAT) lineBreakMode:NSLineBreakByWordWrapping];
