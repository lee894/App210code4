...
@synthesize titlesFontColor;
@synthesize titlesEnableFontColor;
...
- (UIColor *)titlesFontColor {
    if (!titlesFontColor) {
        titlesFontColor = [UIColor lightGrayColor];
    }
    return titlesFontColor;
}
...
//            [tab viewWithTag:DARKER_BACKGROUND_VIEW_TAG].backgroundColor = [UIColor colorWithWhite:0 alpha:0.15f];
            [tab viewWithTag:DARKER_BACKGROUND_VIEW_TAG].backgroundColor = [UIColor colorWithWhite:1 alpha:1.0];
    ...
    if (tabItem.tabState == TabStateEnabled) {
        ...
        titleLabel.textColor = titlesEnableFontColor;
        ...
        titleLabel.textColor = titlesFontColor;
