...
- (void)setup
{
    ...
    swipeGestureLeft.delegate = (id<UIGestureRecognizerDelegate>)self;
    swipeGestureLeft.direction = UISwipeGestureRecognizerDirectionLeft;
    [contentView addGestureRecognizer:swipeGestureLeft];
    
    UISwipeGestureRecognizer* swipeGestureRight = [[UISwipeGestureRecognizer alloc] initWithTarget:self action:@selector(didSwipe:)];
    swipeGestureRight.delegate = (id<UIGestureRecognizerDelegate>)self;
    swipeGestureRight.direction = UISwipeGestureRecognizerDirectionRight;
    [contentView addGestureRecognizer:swipeGestureRight];
    ...
    if (scrollEnabled) {
        ...
        switch (swipeGesture.state) {
            ...
            case UIGestureRecognizerStateCancelled:
				...
				{
					[delegate carouselDidEndDragging:self willDecelerate:NO];
				}
                break;
            default:
                break;
