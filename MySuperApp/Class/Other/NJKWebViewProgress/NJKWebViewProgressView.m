...
-(void)configureViews
{
    ...
    UIColor *tintColor = [UIColor colorWithRed:255.f / 255.f green:1.f / 255.f blue:251.f / 255.f alpha:1.0]; // iOS7 Safari bar color
//    tintColor = [UIColor colorWithHexString:@"DD1423"];
//    tintColor = [UIColor colorWithHexString:@"00ff00"];
