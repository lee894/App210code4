...
@interface VuserLoginVuserLoginModel ()

- (id)objectOrNilForKey:(id)aKey fromDictionary:(NSDictionary *)dict;

@end

@implementation VuserLoginVuserLoginModel
...
{
    VuserLoginVuserLoginModel *instance = [[VuserLoginVuserLoginModel alloc] initWithDictionary:dict];
    return instance;
}
